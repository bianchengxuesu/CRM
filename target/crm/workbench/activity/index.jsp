...
<script type="text/javascript">
	...
	$(function(){
		...
		//通过下面的选择框控制全选框，比如都选中就把复选框check了，有一个没选就把复选框选中取消
		//以下这种做法是不行的
		/*
		...
		*/
		...
		$("#searchBtn").click(function () {
			...
			/*
				点击查询按钮时，我们应将搜索框的信息保存起来，保存到隐藏域中
			 */
		...
		//未修改按钮绑定事件，打开修改操作的活动模态窗口
		$("#editBtn").click(function () {


			//我们习惯在jQuery对象前加个$符号，和dom对象区分开
			var $xz = $("input[name=xz]:checked");
			...
			//只选了一条的情况
				...
				$.ajax({
					...
					type: "get", //增删改用post,查询用get，此处只是将表单读取
					dataType: "json",
					success: function (data) {
						/*
							data:
		  ...
		  $.ajax({
			...
			success : function (data) {
				/*
					...
					data
						我们需要的 [{市场活动1}，{市场活动2}，{市场活动3}，] List<Activity> aList
						分页查询插件需要的：查询到的总记录数
						{"total":100}  int total

						总data: {"total":100,"dataList":[{市场活动1}，{市场活动2}，{市场活动3}]}
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="height: 80px;">
				<form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
				  ...
				  <%--button的type不要用submit，submit将会全局刷新，我们要用异步刷新--%>
